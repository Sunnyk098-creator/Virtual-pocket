...
export default async function handler(req, res) {
    ...
    try {
        ...
        if ((adminData.balance || 0) < withdrawAmount) {
        ...
        // 7. Process Transactions (Atomic Updates via Updates Object)
        const updates = {};
        ...
        // B) Add to Receiver
        updates[`users/${receiverPhone}/balance`] = increment(withdrawAmount);
